...
namespace kifome.Persistencia
{
    ...
    public class PedidoBD
    {
        ...
        public bool Insert(Pedido pedido)
        {
            ...
            string sql = "INSERT INTO ped_pedido(ped_nomecliente, ped_contatocliente, ped_guid, ped_quantidadetotal, ped_valortotal, ped_status, ped_dataentrada, ped_datapronto, ped_dataprevista, ped_qtddias) VALUES (?nomecliente, ?contatocliente, ?produto, ?quantidadetotal, ?valortotal, ?status, ?dataentrada , ?datapronto, ?dataprevista, ?qtddias)";
