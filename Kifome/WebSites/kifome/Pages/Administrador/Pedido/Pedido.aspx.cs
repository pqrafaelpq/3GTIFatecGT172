...
public partial class Pages_Administrador_Test : System.Web.UI.Page
{
    ...
    private void incluirNoDataTable(string produto, int quantidade, double valorcento, DataTable dtb)
    {
        ...
        double total = Convert.ToDouble(dtb.Compute("Sum(Subtotal)", ""));
        lblValorTotal2.Text = "R$ " + total.ToString("N2");
    ...
    protected void btnSalvar_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            pedido.ValorTotal = Convert.ToDouble(lblValorTotal2.Text.Remove(0,3));
