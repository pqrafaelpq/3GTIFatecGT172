...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label1" runat="server" Text="Relatório de Frequência de Entrega"></asp:Label>
        <br />
        <br />
        ...
        <asp:GridView ID="gvPedidos" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ped_dataentrada" HeaderText="Data Entrada" />
                <asp:BoundField DataField="ped_datapronto" HeaderText="Data Pronto" />
                <asp:BoundField DataField="ped_qtddias" HeaderText="Qtd de Dias" />
            </Columns>
...
&nbsp;<asp:Label ID="lblTotalPedidos" runat="server"></asp:Label>
        <br />
&nbsp;<asp:Label ID="lblTotaldeDias" runat="server"></asp:Label>
        <br />
&nbsp;<asp:Label ID="lblFrequencia" runat="server"></asp:Label>
        <br />
